...
class CharacterLoader(private val textureCache: TextureCache) {
    ...
    private fun createLimbs(): List<CharacterLimb> {
        return listOf(
                ...
                CharacterLimb("right_foot", 1f, Material.FLESH, true),
                CharacterLimb("right_shin", 1f, Material.FLESH, true),
                CharacterLimb("right_thigh", 1f, Material.FLESH),
                CharacterLimb("left_thigh", 1f, Material.FLESH),
