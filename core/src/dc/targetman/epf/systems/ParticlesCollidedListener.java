...
public final class ParticlesCollidedListener implements CollidedListener {
	...
	public final void collided(final Entity collider, final Entity collidee) {
		...
		if (colliderPart != null && collideePart != null) {
			Vector3 position = collider.get(TransformPart.class).getTransform().getPosition3();
			Vector2 velocity = new Vector2(0, 0)/*collider.get(TranslatePart.class).getVelocity()*/;
